...
public class Lottery4000 {
	...
	public static void main(String[] args) {
		...
		// TODO Auto-generated method stub
// Demonstrating a continue and a breaker   at 7500 loops . 
		/*  From 4000 to 10000 loops and stopping at 7500  .  */

int BreakingPoint = 7500;

		
		System.out.println("    Welcome to the  lucky number machine loop \n"
				+ "this will print numbers between 4000 to 10000 , with every tenth number a lucky number ! \n"
...
System.out.println(" Rolling the lottery, \" HOLD ONTO YOUR NUMBER FOR THE DRAWINGS !   \" Your \n"
...
System.out.println(" Your lucky tenth number is " + SomeNumber + " , continuing until \n"
		+ "lotto - 7500 " );
